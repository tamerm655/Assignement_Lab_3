...
public class CountriesAndCities {
    ...
    public static void main(String[] args) {
       ...
       List<Countries> countries = countryDAO.readCountryInfo("D:\\Java_course\\day_3\\Countries.csv");
        
       CityDAO cityDAO = new CityDAO();
       List<Cities> cities = cityDAO.readCityInfo("D:\\Java_course\\day_3\\Cities.csv");
